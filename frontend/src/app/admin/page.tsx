...
export default function AdminPanel() {
  ...
  const handleEditEmployeeClick = (emp: Employee) => {
    ...
    if (sched && (sched as any).type === 'rotating') {
      ...
      let numWeeks = 0;
      while ((sched as any)[`week${numWeeks + 1}`]) {
        numWeeks++;
        loadedSchedule[`week${numWeeks}`] = (sched as any)[`week${numWeeks}`];
      }
      if (numWeeks === 0) {
        loadedSchedule['week1'] = getWeeklyScheduleDefault(emp.default_rest_day);
      }
